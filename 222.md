...
[cite_start]**Project Role:** Data Analytics Manager / Project Lead [cite: 1, 2]
[cite_start]**Domain:** EdTech / Interactive Kids Online Courses [cite: 5, 25]
[cite_start]**Core Tech Stack:** Advanced SQL (Hive/Presto), JSON Parsing, Funnel Analytics, A/B Testing, Project Management, Team Leadership [cite: 14, 15, 17]

## 📌 Executive Summary & Business Value

[cite_start]The core business objective of this project was to optimize product content, enhance user experience, and improve retention[cite: 5]. [cite_start]By leading a 2-person analytics team and shifting our operational model from reactive troubleshooting to proactive data-driven intervention, we successfully reduced user churn and drove measurable conversion growth in highly interactive online kids' classes[cite: 2, 5].

**Core Outcomes:**

  * [cite_start]**Leap in Product Experience & Retention:** Successfully optimized core interactive course content[cite: 5]. [cite_start]A/B testing verified that the optimized courses achieved a **31% increase in user satisfaction** and an **18% lift in user retention**[cite: 5].
  * [cite_start]**Boosted Organizational R\&D Efficiency:** Established a "Courseware Optimization Database," solidifying it as the core reference standard for the Pedagogy and Interaction departments[cite: 13, 17]. [cite_start]This boosted human resource efficiency by **30%+** and reduced average course production time from **30 hours to 20 hours**[cite: 13, 21].
...
[cite_start]I abandoned coarse-grained page funnels[cite: 15]. Instead, by parsing unstructured raw data, I built a highly granular **User Behavior Trajectory Tree**, tracking the complete user journey from:
[cite_start]`Entering Module -> Encountering Task -> Specific Scene -> Micro-interaction`[cite: 15, 17].

[cite_start]This allowed us to pinpoint interaction nodes that caused repeated user errors and high-frequency misoperations, providing clear, data-driven guidance for content R\&D[cite: 17, 33].
...
[cite_start]Using the trajectory model, I located and optimized numerous interaction defects causing high-frequency misoperations[cite: 17, 33]. Below are 3 typical cases:

| Task / Scene | Data Insight (Root Cause Drill-down) | Business Action (Cross-Functional Execution) |
| :--- | :--- | :--- |
| **1. Quantity Division (Bones)** | [cite_start]**75.1% Error Rate:** Users only divided the bones physically but didn't type the numbers, leading the system to mark it as incorrect[cite: 17, 33]. | [cite_start]**Collaborated with UX & R\&D:** Added voice prompts and highlighted brackets; adjusted evaluation logic to accept physical division actions[cite: 13, 21]. |
| **2. Find the Cylinder (Bucket)** | [cite_start]**72.0% Error Rate:** The visual perspective design made the 2D bucket appear to have cylindrical features, causing visual ambiguity[cite: 17, 33]. | [cite_start]**Aligned Art & Product Teams:** Increased the visual difference between the top and bottom diameters of the bucket graphic to eliminate ambiguity[cite: 13, 19]. |
| **3. Connecting Curves (Wavy Lines)** | [cite_start]**38.9% Error Rate:** Users only selected one of the wavy lines and rushed to the next step, resulting in omission errors[cite: 17, 33]. | [cite_start]**Led UI Optimization:** Added a "total line segment count prompt" and a confirmation "Submit button" to prevent rushing[cite: 19, 21]. |
...
[cite_start]Clarified the end-to-end collaboration pipeline across 5 key roles (Data Analytics, User Data, Pedagogy, Interaction Design, and Courseware Product)[cite: 7, 11].

### 2\. Strategic Evaluation Framework: Project Mindmap

[cite_start]Systematically broke down the core metrics of "Class Completion Rate" and "First-Attempt Accuracy," establishing a structured evaluation framework for the pedagogy and product teams[cite: 5, 31].

### 3\. Data-Driven UX Redesign (Before & After)

[cite_start]Visually demonstrates how granular behavioral data insights directly guided UI modifications to eliminate visual ambiguity and operational roadblocks[cite: 17, 19, 21].
