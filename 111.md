...
This mechanism clarified the end-to-end collaboration pipeline across 5 key roles (Data Analytics, Courseware Product, User Data, Interaction Design, and Pedagogy). By establishing a standardized business closed-loop, we ensured that every anomaly detected by the SQL pipeline is systematically screened, redesigned, and re-deployed.

![SOP Workflow](images/SOP_workflow.jpg)

---

### 2. Strategic Evaluation Framework: Project Mindmap
This framework systematically broke down complex business goals like "Retention" into actionable data points, such as Class Completion Rate and First-Attempt Accuracy. It serves as a structured, data-driven "North Star" for the pedagogy and product teams to objectively assess courseware quality.

![Project Mindmap](images/project_mindmap.jpg)

---

### 3. Data-Driven UX Redesign (Before & After)
These visual assets demonstrate how granular behavioral trajectory modeling directly translates into measurable UI modifications. By identifying specific interaction roadblocks—such as visual ambiguity in 2D perspectives—we eliminated operational friction and significantly improved the learning experience.

![Data-Driven UX Redesign Comparison](images/Data-Driven_UX_Redesign_Comparison.jpg)
